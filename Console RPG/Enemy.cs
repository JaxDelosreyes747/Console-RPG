...
namespace Console_RPG
{
    class Enemy : Entity
    {
        ...
        public static Enemy imp = new Enemy(name: "Imp", hp: 75, mana: 40, new Stats(strength: 2, defense: 15, maxhp: 75, maxmana: 40), coinsDroppedOnDefeated: 50, experiencePointsOnDefeated: 100);
